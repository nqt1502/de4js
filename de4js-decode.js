self.addEventListener('message', function(e) {
  ...
  if (packer === 'evalencode') {
    ...
    try {
      self.importScripts('https://cdn.jsdelivr.net/gh/nqt1502/de4js@main/de4js-aadecode.js');
    ...
    try {
      self.importScripts('https://cdn.jsdelivr.net/gh/nqt1502/de4js@main/de4js-jjdecode.js');
    ...
    try {
      self.importScripts('https://cdn.jsdelivr.net/gh/nqt1502/de4js@main/de4js-urlencode_unpacker.js');
    ...
    try {
      self.importScripts('https://cdn.jsdelivr.net/gh/nqt1502/de4js@main/de4js-p_a_c_k_e_r_unpacker.js');
    ...
    try {
      self.importScripts('https://cdn.jsdelivr.net/gh/nqt1502/de4js@main/de4js-javascriptobfuscator_unpacker.js');
    ...
    try {
      self.importScripts('https://cdn.jsdelivr.net/gh/nqt1502/de4js@main/de4js-myobfuscate_unpacker.js');
